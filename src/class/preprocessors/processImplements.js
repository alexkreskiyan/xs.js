...
(function (root, ns) {
    ...
    xs.class.preprocessors.add('processImplements', function (Class, descriptor) {
        ...
        //process mixins list
        xs.log('xs.class.preprocessors.processImplements[', Class.label, ']. Mixins:', mixins.toSource());
        //namespace shortcut
    ...
    var _applyMixins = function (target, mixins) {
        ...
        mixins.each(function (name, alias) {
            ...
            xs.log('xs.class.preprocessors.processImplements[', target.label, ']. Mixing in:', Mixin.label, 'as', alias);
