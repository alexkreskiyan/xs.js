/**
 * Event class for events, being thrown before some data is added to xs.util.Collection
 *
 * @author Alex Kreskiyan <a.kreskiyan@gmail.com>
 *
 * @class xs.util.collection.AddBeforeEvent
 *
 * @extends xs.class.Base
 */
xs.define(xs.Class, 'ns.AddBeforeEvent', function (self) {
