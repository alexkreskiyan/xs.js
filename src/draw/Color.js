    ...
    xs.define(ns + '.draw.Color', function () {
            ...
            var tryRgbObject = function (value) {
                ...
                if (value.red < 0 || value.red > 255 ||
                    value.green < 0 || value.green > 255 ||
                    value.blue < 0 || value.blue > 255) {
                    return false;
                }
            ...
            var tryHslObject = function (value) {
                ...
                if (value.hue < 0 || value.hue > 360 ||
                    value.saturation < 0 || value.saturation > 1 ||
            ...
            var tryHslCss = function (css) {
                ...
                var color = new Color(),
                    type = value[1],
                    hue = +value[2],
                    saturation = +value[3] / 100,
                    lightness = +value[4] / 100,
                    alpha = +value[5];
                ...
                methods: {
                    ...
                    toRgb: function (options) {
                        ...
                        if (options.format.toLowerCase() == 'array') {
                            if (options.alpha) {
                                return [me.red, me.green, me.blue, me.alpha];
                            } else {
                    ...
                    toHsl: function (options) {
                        ...
                        if (options.format.toLowerCase() == 'array') {
                            if (options.alpha) {
                                return [me.hue, me.saturation, me.lightness, me.alpha];
                            } else {
                                return [me.hue, me.saturation, me.lightness];
                            }
                        } else {
                            if (options.alpha) {
