 ...
 */
xs.define(xs.Class, 'ns.pointer.Enter', function (self, imports) {
    ...
    Class.static.method.capture = function (element) {
        ...
        element.private.el.addEventListener(self.parent.pointerEvents.pointerEnter, capture.handlePointerEnter);

        return capture;
    };

    Class.static.method.release = function (element, capture) {
        element.private.el.removeEventListener(self.parent.pointerEvents.pointerEnter, capture.handlePointerEnter);
    };
