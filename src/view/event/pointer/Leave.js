 ...
 */
xs.define(xs.Class, 'ns.pointer.Leave', function (self, imports) {
    ...
    Class.static.method.capture = function (element) {
        ...
        element.private.el.addEventListener(self.parent.pointerEvents.pointerLeave, capture.handlePointerLeave);

        return capture;
    };

    Class.static.method.release = function (element, capture) {
        element.private.el.removeEventListener(self.parent.pointerEvents.pointerLeave, capture.handlePointerLeave);
    };
