/**
 * Event class for events, being thrown when content is selected in element
 *
 * @author Alex Kreskiyan <a.kreskiyan@gmail.com>
 *
 * @class xs.view.event.content.Select
 *
 * @extends xs.class.Base
 */
xs.define(xs.Class, 'ns.content.Select', function (self, imports) {
    ...
    Class.static.method.capture = function (target) {
        ...
        capture.handleSelect = xs.bind(handleSelect, capture);
        target.private.el.addEventListener('select', capture.handleSelect);
    ...
    Class.static.method.release = function (target, capture) {
        ...
        target.private.el.removeEventListener('select', capture.handleSelect);
    };
