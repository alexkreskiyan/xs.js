/**
 * Event class for events, being thrown before some data is removed from xs.data.Collection
 *
 * @author Alex Kreskiyan <a.kreskiyan@gmail.com>
 *
 * @class xs.data.enumerable.event.RemoveBefore
 *
 * @extends xs.class.Base
 */
xs.define(xs.Class, 'ns.RemoveBefore', function (self) {
