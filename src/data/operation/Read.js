...
/**
 * xs.data.operation.Read represents operation, performed by proxy with model, being read from server
 *
 * @author Alex Kreskiyan <a.kreskiyan@gmail.com>
 *
 * @class xs.data.operation.Read
 *
 * @extends xs.data.operation.Operation
 */
xs.define(xs.Class, 'ns.operation.Read', function (self, imports) {
