...
module('xs.enum.Enum', function () {
    ...
    test('processors add', function () {
        var me = this;
        //setUp
        me.stack = xs.enum.preprocessors;
    ...
    test('process enum', function () {
        ...
        me.stack.add('two', me.verifier, function (self, descriptor, ready) {
            self.descriptor.chain += 'two';
            setTimeout(ready, 100);

            return false;
        });
        me.stack.add('three', me.verifier, function (self, descriptor, ready) {
        ...
        xs.Enum({
            ...
            strictEqual(Enum.descriptor.chain, 'onetwothree');
