xs.define(xs.Class, 'ns.tests.dom.pointer.stage.ContextMenu', function (self) {
    ...
    Class.constant.instruction = 'Call context menu 3 times.';
    ...
    Class.method.start = function () {
        ...
        sandboxEl.addEventListener('contextmenu', countdownHandler);
        ...
        me.private.cleanUp = function () {
            sandboxEl.removeEventListener('contextmenu', countdownHandler);
