...
test('3. Creation simple: sample', function () {
    ...
    //check instances
    ok(instBase instanceof xs.class.Class.demo.Base, 'check instance of xs.class.Class.demo.Base is correct referred');
    ok(instParent instanceof xs.class.Class.demo.Parent, 'check instance of xs.class.Class.demo.Parent is correct referred');
    ok(instChild instanceof xs.class.Class.demo.Child, 'check instance of xs.class.Class.demo.Child is correct referred');
});
